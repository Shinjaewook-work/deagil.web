...
- Vercel currently has no project environment variables; add the three public web variables from `daegil_web/.env.example` before testing Google login or Rewarded ads.

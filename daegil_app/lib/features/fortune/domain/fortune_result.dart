    ...
    : super(
        ...
        sections: const [
          FortuneResultSection(
            title: '재물운',
            lines: [
              '작은 지출을 한 번 더 살펴보면 좋은 흐름을 지킬 수 있어요.',
              '미뤄둔 정리가 실속으로 이어진다냥.',
              '충동적인 결정은 오후로 미뤄보세요.',
            ],
          ),
          FortuneResultSection(
            ...
            lines: [
              ...
              '짧은 안부가 좋은 인상을 남겨요.',
              '서운함은 결론보다 맥락부터 나눠보세요.',
            ],
          ),
          FortuneResultSection(
            title: '직장·학업운',
            lines: [
              '가장 작은 할 일부터 시작하면 집중이 살아나요.',
              '오전에 정리한 순서가 오후를 가볍게 해준다냥.',
              '완벽함보다 제출 가능한 초안을 먼저 만드세요.',
            ],
          ),
          FortuneResultSection(
            title: '인간관계운',
            lines: [
              ...
              '고마운 마음을 짧게 표현해보세요.',
              '대답을 서두르지 않으면 오해를 줄일 수 있어요.',
            ],
          ),
          FortuneResultSection(
            title: '컨디션운',
            lines: [
              '물을 챙겨 마시고 한 번쯤 어깨를 풀어주세요.',
              '짧은 산책이 생각을 환기해준다냥.',
              '늦은 밤에는 화면 밝기를 낮춰보세요.',
            ],
          ),
        ],
        goodToDo: const ['할 일을 세 가지로 줄이기', '고마운 사람에게 안부 보내기', '책상 위 한 곳 정리하기'],
        avoid: const ['급한 결론 내리기', '준비 없이 큰 약속 잡기', '피곤함을 참은 채 계속 밀어붙이기'],
        luckyNumber: 7,
        luckyColor: '옥빛',
        luckyTime: '오후 3시',
        luckyKeyword: '정돈',
